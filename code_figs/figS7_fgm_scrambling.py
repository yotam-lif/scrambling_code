...
# data/sim/gen_data. This figure only ever reads them.
...
def resolve_fgm_data_dir():
    ...
    data_candidates = [script_dir.parent / "data" / "sim" / "fgm", script_dir.parent / "data" / "sim" / "FGM"]
...
def load_reanchored():
    ...
    data/sim/gen_data/gen_dat_fgm_reanchored.py. It holds two things: `cells`, the
    ...
    if not _REANCHORED_CACHE:
        ...
        if not path.exists():
            raise FileNotFoundError(
                ...
                f"Generate it with:  cd data/sim/gen_data && "
...
def load_sweep(filename, mode):
    ...
    data/sim/gen_data/gen_dat_fgm_constrained.py. The figure never simulates."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Scrambling timescales in FGM. Panels A-C track the motion of "
                    ...
                    "data/sim/gen_data/gen_dat_fgm_constrained.py and "
